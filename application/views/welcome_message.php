...
<div class="login-box">
  <div class="login-logo">
    <a href="<?=base_url()?>"><b><i class="fa fa-credit-card"></i> Pagoos</b>ADMIN</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <a href="<?=site_url('home-gestor')?>" class="text-center">Esqueceu a senha?</a>
